...
import { View, TextInput, Button, FlatList, Text, TouchableOpacity, ActivityIndicator, SafeAreaView, StatusBar, StyleSheet } from 'react-native';
        ...
        <View>
            <View style={{ flexDirection: 'row', padding: 10, alignItems: 'center' }}>
                ...
                {isLoading ? (
                    ...
                    <TouchableOpacity onPress={fetchMovies} style={{
                        marginLeft: 10,
                        borderStyle: 'solid',
                        padding: 10,
                        borderWidth: 1,
